...
Step 4: Call the function "Find_best_F1" from the Alignment_evaluation file. This requires the file paths of the MIDI files you want compared and outputs (true_positives, false_positives, false_negatives, F1) for those files with alignment such that F1 is maximised